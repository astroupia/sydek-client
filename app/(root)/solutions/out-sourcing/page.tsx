  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 overflow-hidden">
        <InteractiveBackground className="absolute inset-0" particleCount={30} />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
              Expert <span className="text-gradient">Outsourcing</span> Solutions
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Access top-tier talent, specialized teams, and procurement services to accelerate your digital
      ...
      <section className="py-16 md:py-24 bg-muted/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-3xl font-bold tracking-tight mb-4">Comprehensive Outsourcing Services</h2>
            <p className="text-lg text-muted-foreground">
              Flexible solutions designed to meet your specific business needs and technical requirements.
            </p>
          </div>
          ...
          <Tabs defaultValue="teams" className="max-w-5xl mx-auto">
            ...
            <TabsContent value="teams" className="mt-0">
              <div className="bg-card rounded-xl border shadow-sm p-6 md:p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div>
                    <h3 className="text-2xl font-bold mb-4">Dedicated Development Teams</h3>
                    <p className="text-muted-foreground mb-6">
                      Access fully-managed, cross-functional teams that seamlessly integrate with your organization. Our
                      teams are assembled based on your specific project requirements and technical needs.
                    </p>
                      ...
                      <div className="w-64 h-64 relative">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="w-24 h-24 bg-background/90 rounded-full flex items-center justify-center shadow-lg">
                            <span className="text-xl font-bold text-gradient">Team</span>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="bg-card rounded-xl border shadow-sm p-6 md:p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div className="order-2 md:order-1">
                    <div className="relative rounded-xl overflow-hidden h-[300px] md:h-[400px] bg-gradient-to-br from-accent/10 to-secondary/10 flex items-center justify-center">
                      <div className="grid grid-cols-3 gap-4 p-6">
                        {[
                          { icon: <Award className="h-6 w-6 text-secondary" />, title: "Senior Developer" },
                          { icon: <Shield className="h-6 w-6 text-accent" />, title: "Security Expert" },
                          { icon: <Zap className="h-6 w-6 text-tertiary" />, title: "DevOps Engineer" },
                          { icon: <Globe className="h-6 w-6 text-secondary" />, title: "UX Designer" },
                          { icon: <Briefcase className="h-6 w-6 text-accent" />, title: "Project Manager" },
                          { icon: <Clock className="h-6 w-6 text-tertiary" />, title: "QA Specialist" },
                        ].map((item, index) => (
                          <div
                            key={index}
                  ...
                  <div className="order-1 md:order-2">
                    <h3 className="text-2xl font-bold mb-4">Individual Expert Outsourcing</h3>
                    <p className="text-muted-foreground mb-6">
                      Augment your team with specialized experts who bring deep domain knowledge and technical expertise
                      to address specific challenges or skill gaps.
                    </p>
            ...
            <TabsContent value="procurement" className="mt-0">
              <div className="bg-card rounded-xl border shadow-sm p-6 md:p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div>
                    <h3 className="text-2xl font-bold mb-4">Strategic Procurement Services</h3>
                    <p className="text-muted-foreground mb-6">
                      Leverage our global network and industry expertise to source the right technology, tools, and
                      services at competitive prices with streamlined procurement processes.
                    </p>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-3xl font-bold tracking-tight mb-4">Why Choose Our Outsourcing Solutions?</h2>
            <p className="text-lg text-muted-foreground">
              Maximize efficiency, reduce costs, and stay ahead with our tailored outsourcing services.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Access skilled professionals from around the world to meet your project needs.",
              },
              {
                icon: <Clock className="h-8 w-8 text-secondary" />,
                title: "24/7 Productivity",
                description: "Leverage time zone differences for round-the-clock progress on your projects.",
              },
              {
                icon: <Shield className="h-8 w-8 text-secondary" />,
                title: "Cost Efficiency",
                description: "Reduce overhead costs while maintaining high-quality output and delivery.",
              },
            ].map((benefit, index) => (
      ...
      <section className="py-16 md:py-24 bg-muted/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Hear from businesses that have transformed with our outsourcing solutions.
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-secondary to-tertiary text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6">Ready to Optimize Your Business?</h2>
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Partner with us to unlock the full potential of outsourcing and drive your success.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
